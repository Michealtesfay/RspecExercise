...
describe "Test Suite sends a post request" do 
	it "should create a new post in the collection" do
		rpost = HTTParty.post "http://lacedeamon.spartaglobal.com/todos", query: {title: "do Something", due: "2016-01-01"}
		expect(rpost["title"] == "do something")
...
describe "Test Suite sends a get request" do 
	it "should create & retrieve an item in the collection using it's specific id" do
		rpost = HTTParty.post "http://lacedeamon.spartaglobal.com/todos", query: {title: "do something mad", due: "2016-01-01"}
...
describe "Test Suite sends a put request" do 
	it "should create & completely update an item in the collection" do
		rpost = HTTParty.post "http://lacedeamon.spartaglobal.com/todos", query: {title: "do something mad", due: "2016-01-01"}
		rput = HTTParty.put "http://lacedeamon.spartaglobal.com/todos/#{rpost["id"]}", query: {title: "do something mad again", due: "2016-01-01"}
